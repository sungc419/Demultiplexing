...
def init_list(lst: list, value: float=0.0) -> list:
    '''This function takes an empty list and will populate it with the value passed in "value". If no value is passed, initializes list with 8values of 0.0.'''
    for x in range(8):
        lst.append(value)
    return lst
...
for nt_pos in range(len(my_list)): 
